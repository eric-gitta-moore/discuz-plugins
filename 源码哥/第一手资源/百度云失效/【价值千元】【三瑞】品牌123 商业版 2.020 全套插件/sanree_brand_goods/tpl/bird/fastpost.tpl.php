  ...
  <div class="cbox">
    ...
    <div class="sr_commain">
      <ul>
        ...
        <li>
          <div class="user_avatar l"><a href="home.php?mod=space&amp;uid={$thread['authorid']}" target=_blank><img src="{$thread[img]}" /></a></div>
    ...
    <div class="report">
      <form  autocomplete="off" id="fastpostform" action="plugin.php?id=sanree_brand_goods&mod=fastpost" method="post"  onSubmit="return fastnewpost(this);">
        ...
        <input type="hidden" name="inajax" id="inajax" value="0" />
        ...
        <div class="input_area">
          <div class="user_avatar l"><a href="home.php?mod=space&amp;uid={$_G[uid]}" target=_blank><img src="{$selfimg}" /></a></div>
          <div class="text_area r">
            <div class="t_infor">
              <div class="t_meta l">{lang sanree_brand:bird_item_hello}<a href="home.php?mod=space&amp;uid={$_G['uid']}" target=_blank>{$_G[username]}</a></div>
