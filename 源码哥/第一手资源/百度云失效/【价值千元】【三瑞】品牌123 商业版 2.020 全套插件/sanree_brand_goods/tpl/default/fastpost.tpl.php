...
<div class="brandcomment">
  ...
  <div class="bd">
	...
	<form  autocomplete="off" id="fastpostform" action="plugin.php?id=sanree_brand_goods&mod=fastpost" method="post"  onSubmit="return fastpost(this);">
		...
		<div class="rightbar">
		  ...
		  {lang sanree_brand_goods:sendstar}
		  <em id="brandstar">
          ...
          <div class="sendbottombar clearall"><span class="toparrow"><span></span></span>
			...
			<span id="desc">{lang sanree_brand_goods:notclickstar}</span>
			</div>
          </div>
        </div>	
		</form>	
