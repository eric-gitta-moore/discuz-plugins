...
$sql = <<<EOF
CREATE TABLE IF NOT EXISTS `pre_sanree_brand_goods_category` (
...
INSERT INTO `pre_sanree_brand_goods_category` (`cateid`, `keywords`, `description`, `name`, `status`, `dateline`, `displayorder`) VALUES
...
CREATE TABLE IF NOT EXISTS `pre_sanree_brand_goods` (
...
CREATE TABLE IF NOT EXISTS `pre_sanree_brand_goods_slide` (
...
INSERT INTO `pre_sanree_brand_goods_slide` (`ID`, `pic1`, `movie1`, `pic2`, `movie2`, `pic3`, `movie3`, `pic4`, `movie4`, `pic5`, `movie5`, `movie11`, `movie22`, `movie33`, `movie44`, `movie55`) VALUES
...
CREATE TABLE IF NOT EXISTS `pre_sanree_brand_goods_voter` (
...
CREATE TABLE IF NOT EXISTS `pre_sanree_brand_goods_voterlog` (
  `tid` mediumint(8) unsigned NOT NULL default '0',
  `bid` mediumint(8) NOT NULL default '0',
  `gid` mediumint(8) NOT NULL,
  `uid` mediumint(8) unsigned NOT NULL default '0',
...
if (!exitscolumn('isgoods','sanree_brand_businesses_module')) {
	$sql="ALTER TABLE `pre_sanree_brand_businesses_module` ADD `isgoods` TINYINT( 1 ) NULL DEFAULT '0';";
	runquery($sql);	
	$sql = "INSERT INTO `pre_sanree_brand_language` (`module` ,`langkey` ,`langvalue` ) VALUES ('goods', 'isgoods', '".$installlang[isgoods]."');";
	runquery($sql);		
}
