...
$sql = <<<EOF
DROP TABLE IF EXISTS `pre_sanree_brand_goods_category`;
DROP TABLE IF EXISTS `pre_sanree_brand_goods`;
DROP TABLE IF EXISTS `pre_sanree_brand_goods_slide`;
DROP TABLE IF EXISTS `pre_sanree_brand_goods_voter`;
DROP TABLE IF EXISTS `pre_sanree_brand_goods_voterlog`;
DROP TABLE IF EXISTS `pre_sanree_brand_goods_diystyle`;
DROP TABLE IF EXISTS `pre_sanree_brand_goods_diytemplate`;
EOF;
