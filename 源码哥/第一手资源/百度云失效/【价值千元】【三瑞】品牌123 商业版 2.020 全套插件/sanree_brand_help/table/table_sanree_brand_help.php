 ...
 *
 *      $Id: table_sanree_brand_help.php 28041 2012-02-21 07:33:55Z chenmengshu $
 */
...
class table_sanree_brand_help extends discuz_table
{
		
	public function __construct() {

		$this->_table = 'sanree_brand_help';
		$this->_pk    = 'helpid';
	...
	public function get_by_helpid($helpid) {
		return XDB::fetch_first("SELECT * FROM %t WHERE helpid=%d", array($this->_table, $helpid));
	}
