...
function chuli(obj){
	if(confirm('{lang sanree_brand_guestbook:temp_deletetip}')){
...
<script src="{sr_brand_guestbook_JS}/msg{C_CHARSET}.js"></script>	
	...
	<div id="ct" class="ct2_a wp cl">
			...
			<div class="tbmu cl">
				<ul class="tb cl">
					<li class="a"><a>{lang sanree_brand_guestbook:temp_deleteguestbook}</a></li>
				</ul>			
				<div id="return_error" style=" display:none"></div>
				<FORM id=postform onsubmit="return chuli(this);" method=post action="plugin.php?id=sanree_brand_guestbook&mod=myguestbook&view=delete" autocomplete="off">
				...
				<table cellspacing="5" cellpadding="5" width="100%">
					...
					<tr>
						<td colspan="2" align="center"><input type="submit" class="sanreebtn pn pnc"  value="{lang sanree_brand_guestbook:temp_deleteguestbook}"> <input onclick="javascript:history.back()" class="sanreebtn pn pnc" type="button" value="{lang sanree_brand_guestbook:temp_back}"></th>						
					</tr>																														
				</table>
				</form>
			</div>
