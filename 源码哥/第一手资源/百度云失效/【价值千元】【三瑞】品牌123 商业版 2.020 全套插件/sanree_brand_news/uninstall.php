...
$sql = <<<EOF
DROP TABLE IF EXISTS `pre_sanree_brand_news_category`;
DROP TABLE IF EXISTS `pre_sanree_brand_news`;
DROP TABLE IF EXISTS `pre_sanree_brand_news_slide`;
DROP TABLE IF EXISTS `pre_sanree_brand_news_voter`;
DROP TABLE IF EXISTS `pre_sanree_brand_news_voterlog`;
DROP TABLE IF EXISTS `pre_sanree_brand_news_diystyle`;
DROP TABLE IF EXISTS `pre_sanree_brand_news_diytemplate`;
EOF;
