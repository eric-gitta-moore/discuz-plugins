...
<link rel="stylesheet" type="text/css" href="source/plugin/sanree_brand_news/tpl/default/newsshow.css?{VERHASH}" />
<link rel="stylesheet" type="text/css" href="source/plugin/sanree_brand_news/tpl/default/fastpost.css?{VERHASH}" />
...
<script language="javascript">
	...
	var langvoter=Array();
	langvoter[0] = '{lang sanree_brand_news:pleasestar}';
	langvoter[1] = '{lang sanree_brand_news:pleasestarstr}';
  ...
  <!--{hook/sanree_brand_userheader}-->  
    <div class="albumlist">
	  <div class="albumleft">
	    ...
	    <div class="newsshow">
		   <div class="ahd"><a>{$newsresult[views]}</a></div>
		   <div class="abd">
		       <h1>{$newsresult[name]}</h1>
			   <div class="ginfo">
					<div class="gcatename">{lang sanree_brand_news:post_newscate}<span>{$newsresult[catename]}</span></div>
					<div class="gdateline">{lang sanree_brand_news:post_dateline}<span>{$newsresult[dateline]}</span></div>
					  <div class="satisfaction">
						<div class="satisfactionc">{lang sanree_brand_news:satisfaction}</div>
						<div class="satisfactiona" title="{lang sanree_brand_news:satisfaction}{$newsresult['satisfaction']}{lang sanree_brand_news:fen}">
						  <div class="satisfactionb" style="width:{$newsresult['satisfactionwidth']}px"></div>
						</div>
					  </div>	
			   </div>
			   <div class="ty">
			   <img src="source/plugin/sanree_brand_news/tpl/default/images/ty.jpg" border="0" usemap="#tyMap" />
			   </div>
		   </div>
		   <div class="gcontenttxt" id="gcontenttxt">{$newsresult[content]}</div>
		   <!--{if count($imglist)>0}-->
           ...
           <div class="clear"></div>
            <script language="javascript">
			var url = 'plugin.php?id=sanree_brand_news&mod=fastpost&tid={$tid}&nid={$nid}';
...
<map name="tyMap" id="tyMap">
<area shape="rect" coords="124,5,148,23" href="javascript:void(0)" onclick="fontsize(16)" />
<area shape="rect" coords="156,5,178,23" href="javascript:void(0)" onclick="fontsize(14)" />
<area shape="rect" coords="185,5,208,23" href="javascript:void(0)" onclick="fontsize(12)" />
<area shape="rect" coords="317,5,340,23" href="javascript:void(0)" onclick="backcolor('#F0F6FC')"/>
<area shape="rect" coords="346,5,369,22" href="javascript:void(0)" onclick="backcolor('#FFFFFF')" />
<area shape="rect" coords="378,5,399,22" href="javascript:void(0)" onclick="backcolor('#F8F8F8')" />
</map>
