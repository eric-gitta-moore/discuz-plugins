...
<div class="brandcomment">
  ...
  <div class="bd">
	...
	<form  autocomplete="off" id="fastpostform" action="plugin.php?id=sanree_brand_news&mod=fastpost" method="post"  onSubmit="return fastpost(this);">
		...
		<div class="rightbar">
		  ...
		  {lang sanree_brand_news:sendstar}
		  <em id="brandstar">
          ...
          <div class="sendbottombar clearall"><span class="toparrow"><span></span></span>
			...
			<span id="desc">{lang sanree_brand_news:notclickstar}</span>
			</div>
          </div>
        </div>	
		</form>	
