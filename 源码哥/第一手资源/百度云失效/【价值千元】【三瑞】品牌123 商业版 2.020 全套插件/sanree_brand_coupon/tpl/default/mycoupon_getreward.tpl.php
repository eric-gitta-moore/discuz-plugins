...
<div class="dealconsumer">
  <h3 class="flb mn sr"><strong>{lang sanree_brand_coupon:dealconsumer}</strong> <span>    
    <a href="javascript:;" class="flbc" onclick="hideWindow('getrewarddlg', 0, 1);" title="{lang close}">{lang close}</a>
    </span> </h3>
  <div class="tuan168item">
    <span id="return_error" style="display:none"></span>
	<span id="succeedmessage"></span>
  <form method="post" action="plugin.php?id=sanree_brand_coupon&mod=mycoupon&view=getreward" autocomplete="on" id="postform" onsubmit="return chkadd(this)">
    ...
    <table class="fire" border="1" bordercolor="E6E6E6" cellpadding="3" cellspacing="0">  		
	 ...
	 <div class="submitbtn5">
		   <div class="mcenter"><a href="javascript:;" onclick="chkadd();">{lang sanree_brand_coupon:getreward}</a></div>
	 </div>	 
