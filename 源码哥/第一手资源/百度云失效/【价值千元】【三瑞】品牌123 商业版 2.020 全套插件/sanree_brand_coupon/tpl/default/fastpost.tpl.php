...
<div class="brandcomment">
  ...
  <div class="bd">
	...
	<form  autocomplete="off" id="fastpostform" action="plugin.php?id=sanree_brand_coupon&mod=fastpost" method="post"  onSubmit="return fastpost(this);">
		...
		<div class="rightbar">
		  ...
		  {lang sanree_brand_coupon:sendstar}
		  <em id="brandstar">
          ...
          <div class="sendbottombar clearall"><span class="toparrow"><span></span></span>
			...
			<input type="image" src="source/plugin/sanree_brand/tpl/good/images/send.jpg" align="absmiddle" />
			<span id="desc">{lang sanree_brand_coupon:notclickstar}</span>
			</div>
          </div>
        </div>	
		</form>	
