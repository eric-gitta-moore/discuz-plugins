...
$sql = <<<EOF
CREATE TABLE IF NOT EXISTS `pre_sanree_brand_coupon_category` (
...
INSERT INTO `pre_sanree_brand_coupon_category` (`cateid`, `keywords`, `description`, `name`, `status`, `dateline`, `displayorder`) VALUES
...
CREATE TABLE IF NOT EXISTS `pre_sanree_brand_coupon` (
  ...
  `rebateproportion` int(11) default NULL,  
  PRIMARY KEY  (`cid`)
) ENGINE=MyISAM;

CREATE TABLE IF NOT EXISTS `pre_sanree_brand_coupon_slide` (
...
INSERT INTO `pre_sanree_brand_coupon_slide` (`ID`, `pic1`, `movie1`, `pic2`, `movie2`, `pic3`, `movie3`, `pic4`, `movie4`, `pic5`, `movie5`, `movie11`, `movie22`, `movie33`, `movie44`, `movie55`) VALUES
...
CREATE TABLE IF NOT EXISTS `pre_sanree_brand_coupon_voter` (
...
CREATE TABLE IF NOT EXISTS `pre_sanree_brand_coupon_voterlog` (
  `tid` mediumint(8) unsigned NOT NULL default '0',
  `bid` mediumint(8) NOT NULL default '0',
  `gid` mediumint(8) NOT NULL,
  `uid` mediumint(8) unsigned NOT NULL default '0',
...
CREATE TABLE IF NOT EXISTS `pre_sanree_brand_coupon_diystyle` (
...
INSERT INTO `pre_sanree_brand_coupon_diystyle` (`diystyleid`, `name`, `content`, `uid`, `username`, `dateline`, `displayorder`, `status`, `issys`) VALUES
(1, 'hotcoupon', 's:62:".stylename{\\r\\n}\\r\\n.stylename ul li{\\r\\n     line-height:20px;\\r\\n}\\r\\n";', 1, 'admin', 1350793879, 0, 1, 1);

CREATE TABLE IF NOT EXISTS `pre_sanree_brand_coupon_diytemplate` (
...
INSERT INTO `pre_sanree_brand_coupon_diytemplate` (`diytemplateid`, `name`, `content`, `uid`, `username`, `dateline`, `displayorder`, `status`, `issys`) VALUES
...
CREATE TABLE IF NOT EXISTS `pre_sanree_brand_coupon_printlog` (
  `printlogid` int(11) unsigned NOT NULL auto_increment,
  ...
  `usedateline` int(11) NOT NULL,
  `canceldateline` int(11) NOT NULL,
  `memo` text,
  `rebatesdate` int(11) NOT NULL,
  PRIMARY KEY  (`printcode`),
  KEY `printlogid` (`printlogid`)
) ENGINE=MyISAM;
EOF;
runquery($sql);

if (!exitscolumn('iscoupon','sanree_brand_businesses_module')) {
	$sql="ALTER TABLE `pre_sanree_brand_businesses_module` ADD `iscoupon` TINYINT( 1 ) NULL DEFAULT '0';";
	runquery($sql);	
	$sql = "INSERT INTO `pre_sanree_brand_language` (`module` ,`langkey` ,`langvalue` ) VALUES ('coupon', 'iscoupon', '".$installlang[iscoupon]."');";
	runquery($sql);		
}
if (!exitscolumn('maxcoupon','sanree_brand_group_module')) {
	$sql="ALTER TABLE `pre_sanree_brand_group_module` ADD `maxcoupon` INT( 11 ) NULL DEFAULT '20';";
	runquery($sql);	
	$sql = "INSERT INTO `pre_sanree_brand_language` (`module` ,`langkey` ,`langvalue` ) VALUES ('coupon', 'maxcoupon', '".$installlang[maxcoupon]."');";
	runquery($sql);	
}
