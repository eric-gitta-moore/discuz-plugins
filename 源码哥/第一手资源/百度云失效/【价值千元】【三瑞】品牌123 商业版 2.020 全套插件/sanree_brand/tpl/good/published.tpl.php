...
<div class="z"> <a href="./" class="nvhm" title="{lang homepage}">$_G[setting][bbname]</a><em>&raquo;</em><a href="{$allurl}">{$maintitle}</a><em>&raquo;</em>{lang sanree_brand:pub_brandbtn} </div>
</div>
<div class="published published_notajax">
  <h3 class="flb mn sr"><em>{lang sanree_brand:published_title}</em></h3>
  ...
  <form method="post" action="plugin.php?id=sanree_brand&mod=published" autocomplete="off" id="postform" onsubmit="return chkadd(this)">
	...
	<input type="hidden" name="gothome" id="gothome" value="1" />
...
<div class="pub_right">
	...
	<div class="newbrand">
	  <div class="hd">{lang sanree_brand:newsbrandtitle}</div>
	  <div class="bd">
	  <ul>
		 <!--{loop $newlist $value}-->
