...
<link rel="stylesheet" type="text/css" href="{SANREE_BRAND_TEMPLATE}/newyear/style.css?{VERHASH}" />
<script src="{SANREE_BRAND_TEMPLATE}/newyear/js/jquery-1.4.2.min.js" type="text/javascript"></script>
<script src="{SANREE_BRAND_TEMPLATE}/newyear/js/tab.js" type="text/javascript"></script>
<script src="{SANREE_BRAND_TEMPLATE}/newyear/js/hello.js" type="text/javascript"></script>
...
<div class="bannerbox">
  <div class="banner">
    <div class="joinus">
      <div class="join"><a href="plugin.php?id=sanree_brand&mod=published" id="publisheddlg"><img src="{SANREE_BRAND_TEMPLATE}/newyear/images/joinus.png" /></a></div>
      <div class="manager"><a href="plugin.php?id=sanree_brand&mod=mybrand"><img src="{SANREE_BRAND_TEMPLATE}/newyear/images/bmanager.png" /></a></div>
    ...
    <div class="typecon">
      <div class="search">
        <form class="s_form" method="post" action="{$allurl}">
          <label class="s_text"><img src="{SANREE_BRAND_TEMPLATE}/newyear/images/sou.png"/></label>
		  ...
		  <input type="image" class="input_button" border="0"  src="{SANREE_BRAND_TEMPLATE}/newyear/images/searchbtn.png" />
        </form>
      </div>
      <!-- /search -->
      <div class="type_more">
  ...
  <div class="indexmainbody" id="indexmainbody">
    <div class="bodyleft">
      ...
      <div class="option" id="option">
        ...
        <!-- /sort -->
        <ul class="listmode">
          <li><a href="{$bigurl}" title="{lang sanree_brand:bigmode}"><img src="{SANREE_BRAND_TEMPLATE}/newyear/images/list_1.png"alt="{lang sanree_brand:bigmode}" /> </a></li>
          <li><a href="{$middleurl}" title="{lang sanree_brand:middlemode}"><img src="{SANREE_BRAND_TEMPLATE}/newyear/images/list_2.png" alt="{lang sanree_brand:middlemode}" /></a></li>
          <li><a href="{$smallurl}" title="{lang sanree_brand:smallmode}"><img src="{SANREE_BRAND_TEMPLATE}/newyear/images/list_3.png" alt="{lang sanree_brand:smallmode}"/></a></li>
        </ul>
        <!-- /listmode -->
      </div>
      <!-- /option -->
  ...
  <!--{hook/sanree_brand_index_right_top}-->
    ...
    <div class="copyright">
      <div class="copyright_img">
        ...
        <div class="bottomimg"><img src="{SANREE_BRAND_TEMPLATE}/newyear/images/copyimg.png" /></div>
      </div>
      <!-- /copyright_img -->
      	<div class="copytext">
