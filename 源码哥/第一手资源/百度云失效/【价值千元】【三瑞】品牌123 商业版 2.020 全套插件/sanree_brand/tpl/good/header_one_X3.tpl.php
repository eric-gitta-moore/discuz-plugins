...
<!--{block brand_header_one}-->
	...
	<!--{if helper_access::check_module('feed')}--><meta name="msapplication-task" content="name=$_G['setting']['navs'][4]['navname'];action-uri=<!--{if !empty($_G['setting']['domain']['app']['home'])}-->http://{$_G['setting']['domain']['app']['home']}<!--{else}-->{$_G[siteurl]}home.php<!--{/if}-->;icon-uri={$_G[siteurl]}{IMGDIR}/home.ico" /><!--{/if}-->
