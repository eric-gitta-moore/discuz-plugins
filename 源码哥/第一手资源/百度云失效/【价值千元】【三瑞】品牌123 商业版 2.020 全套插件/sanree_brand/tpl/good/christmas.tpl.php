...
<link rel="stylesheet" type="text/css" href="{SANREE_BRAND_TEMPLATE}/christmas/style.css?{VERHASH}" />
<script src="{SANREE_BRAND_TEMPLATE}/christmas/js/jquery-1.4.2.min.js" type="text/javascript"></script>
<script src="{SANREE_BRAND_TEMPLATE}/christmas/js/tab.js" type="text/javascript"></script>
<script src="{SANREE_BRAND_TEMPLATE}/christmas/js/hello.js" type="text/javascript"></script>
...
<div class="headerbox">
  <div class="header">
    ...
    <div class="menubox">
	  ...
	  <!--{else}--><a href="member.php?mod=logging&action=logout&formhash={FORMHASH}">{lang logout}</a><!--{/if}-->&nbsp;&nbsp;&nbsp;&nbsp;
	  <a onClick="SetHome(window.location)" href="javascript:void(0)">{lang sanree_brand:sethome}</a>&nbsp;&nbsp;&nbsp;&nbsp;
	  <a onClick="AddFavorite(window.location,document.title)" href="javascript:void(0)">{lang sanree_brand:favorite}</a></div>
      <div class="topmenu">
        <ul>
          ...
          <!--{if $new_goodslist}--><li><a href="{$modurl_goods}">{lang sanree_brand:h_goods}</a></li><!--{/if}-->
          <!--{if $new_newslist}--><li><a href="{$modurl_news}">{lang sanree_brand:h_news}</a></li><!--{/if}-->
          <!--{if $new_couponlist}--><li><a href="{$modurl_coupon}">{lang sanree_brand:h_coupon}</a></li><!--{/if}-->
        </ul>
      </div>
      <!-- /topmenu --> 
    </div>
...
<div class="bannerbox">
  <div class="banner">
    <div class="joinus">
      <div class="join"><a href="plugin.php?id=sanree_brand&mod=published" id="publisheddlg"><img src="{SANREE_BRAND_TEMPLATE}/christmas/images/joinus.png" /></a></div>
      <div class="manager"><a href="plugin.php?id=sanree_brand&mod=mybrand"><img src="{SANREE_BRAND_TEMPLATE}/christmas/images/bmanager.png" /></a></div>
...
<div class="tablists">
  <div class="tabbox" id="statetab">
    <ul class="tabbtn">
      ...
      <!--{if $re_goodslist}--><li><a href="{$modurl_goods}" target="_blank">{lang sanree_brand:h_goods}</a></li><!--{/if}-->
      <!--{if $re_newslist}--><li><a href="{$modurl_news}" target="_blank">{lang sanree_brand:h_news}</a></li><!--{/if}-->
      <!--{if $re_couponlist}--><li><a href="{$modurl_coupon}" target="_blank">{lang sanree_brand:h_coupon}</a></li><!--{/if}-->
    </ul>
    <!-- /tabbtn -->
    ...
    <div class="tabcon" style="display: none;">
      <div class="index_news">
        <div class="l_news">
          ...
          <!-- /news_list -->
          <div class="img_news"> 
			<a href="{$re_news_imglist[0][url]}" target="_blank" title="{$re_news_imglist[0][name]}">
        ...
        <div class="r_news">
          ...
          <!-- /news_list -->
          <div class="img_news"> 
		  		<a href="{$re_news_imglist[2][url]}" target="_blank" title="{$re_news_imglist[2][name]}">
    ...
    <div class="typecon">
      <div class="search">
        <form class="s_form" method="post" action="{$allurl}">
          <label class="s_text"><img src="{SANREE_BRAND_TEMPLATE}/christmas/images/sou.png"/></label>
		  ...
		  <input type="image" class="input_button" border="0"  src="{SANREE_BRAND_TEMPLATE}/christmas/images/searchbtn.png" />
        </form>
      </div>
      <!-- /search -->
      <div class="type_more">
  ...
  <div class="indexmainbody" id="indexmainbody">
    <div class="bodyleft">
      ...
      <div class="option" id="option">
        ...
        <!-- /sort -->
        <ul class="listmode">
          <li><a href="{$bigurl}" title="{lang sanree_brand:bigmode}"><img src="{SANREE_BRAND_TEMPLATE}/christmas/images/list_1.png"alt="{lang sanree_brand:bigmode}" /> </a></li>
          <li><a href="{$middleurl}" title="{lang sanree_brand:middlemode}"><img src="{SANREE_BRAND_TEMPLATE}/christmas/images/list_2.png" alt="{lang sanree_brand:middlemode}" /></a></li>
          <li><a href="{$smallurl}" title="{lang sanree_brand:smallmode}"><img src="{SANREE_BRAND_TEMPLATE}/christmas/images/list_3.png" alt="{lang sanree_brand:smallmode}"/></a></li>
        </ul>
        <!-- /listmode -->
      </div>
      <!-- /option -->
  ...
  <!--{hook/sanree_brand_index_right_top}-->
    ...
    <div class="brand">
      <div class="tabbox" id="brandtab">
        <ul class="tabbtn">
          <!--{if $new_goodslist}--><li><a>{lang sanree_brand:h_goods}</a></li><!--{/if}-->
          <!--{if $new_newslist}--><li><a>{lang sanree_brand:h_news}</a></li><!--{/if}-->
          <!--{if $new_couponlist}--><li><a>{lang sanree_brand:h_coupon}</a></li><!--{/if}-->
        </ul>
        <!-- /tabbtn -->
        <div class="tabcon" style="display: block;">
          <div class="commodity">
        ...
        <div class="tabcon" style="display: none;">
          <div class="sidebar_coupons">
            <ul>
              ...
              <li>
				<div class="cou_left"><a href="{$cate[url]}" target="_blank" title="{$cate[name]}"><img width="80px" height="80px" {$picload}="{$cate[pic]}" />
				</a></div>
                <div class="cou_right"> 
				  <div class="cou_title"><a href="{$cate[url]}" target="_blank" title="{$cate[name]}">{$cate[name]}</a></div> 
    ...
    <div class="copyright">
      <div class="copyright_img">
        ...
        <div class="bottomimg"><img src="{SANREE_BRAND_TEMPLATE}/christmas/images/copyimg.png" /></div>
      </div>
      <!-- /copyright_img -->
      	<div class="copytext">
	  		{lang sanree_brand:h_brand123}{lang sanree_brand:h_sanree}
			V&nbsp;&nbsp;{$pluginversion}&nbsp;&nbsp;For&nbsp;&nbsp;X2,&nbsp;X2.5!<br />
			&copy;<a href="http://www.fx8.cc/" target="_blank">Sanree.com</a>
		</div>
    </div>
	<!--{else}-->
