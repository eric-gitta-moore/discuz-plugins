	...
	$.fn.kinMaxShow = function(user_options) {
		...
		k.setLayout = function() {
			...
			$('.' + k.prename + 'image_item', k.self).each(function() {
				...
				if (a.length) {
					var image = a.children('imga').attr('src');
					a.children('imga').remove();
					a.addClass(k.prename + 'coverlink');
				} else {
					var image = $(this).children('imga').attr('src');
					$(this).children('imga').remove();
				}
				$(this).css({
					'z-index': 1
				});
		...
		k.setOpacity = function() {
			...
			$('.' + k.prename + 'image_item', k.self).eq(k.index).animate({
				opacity: 1
			}, options.switchTime, options.easing, function() {
