            ...
            <!--{if $picturecatelist}-->
                ...
                <!--{loop $picturecatelist $picture}-->
                    <li class=clearall onMouseMove="showthis({$picture[albumid]})" onMouseOut="hidethis({$picture[albumid]})">
                        <a href="javascript:;">
                            <div class="al_ti">
								<img onClick="zoom(this, '{$picture[pic]}')" id='aimg_{$picture[albumid]}' src="$_G[siteurl]{NICE_CSS}timthumb.php?src=$_G[siteurl]{$picture[thumbpic]}&h=218&w=218&zc=1" zoomfile="{$picture[pic]}" title="{$picture[albumname]}" alt="{$picture[albumname]}" />
							</div>
