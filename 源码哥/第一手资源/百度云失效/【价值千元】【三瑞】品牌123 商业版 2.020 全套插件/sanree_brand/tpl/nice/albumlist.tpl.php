...
<!--{/if}-->
<link type="text/css" rel="stylesheet" href="{NICE_CSS}cr.css" />
<link type="text/css" rel="stylesheet" href="{NICE_CSS}album.css" />
    ...
    <div class="al_cb">
          ...
          <!--{if $albumcatelist}-->
                ...
                <!--{loop $albumcatelist $album}-->
                    <li>
                    <a href="{$album[url]}" onClick="atarget(this)" target="_blank">
                        <div class="al_timg">
                            <img src="$_G[siteurl]{NICE_CSS}timthumb.php?src=$_G[siteurl]{$album[pic]}&h=218&w=218&zc=1">
                ...
                <!--{loop $newlist $value}-->
                    <li>
                        <a href="{$value[url]}" target="_blank">
                        	<div class="al_ll"><img src="$_G[siteurl]{NICE_CSS}timthumb.php?src=$_G[siteurl]{$value[poster]}&h=60&w=60&zc=1" /></div>
                            <div class="al_slt">
