...
class table_sanree_brand_category  extends discuz_table {
	public function __construct() {

		$this->_table = 'sanree_brand_category';
		$this->_pk    = 'cateid';
	...
	public function get_by_cateid($cateid) {
		return XDB::fetch_first("SELECT * FROM %t where cateid=%d", array($this->_table, $cateid));
	}
