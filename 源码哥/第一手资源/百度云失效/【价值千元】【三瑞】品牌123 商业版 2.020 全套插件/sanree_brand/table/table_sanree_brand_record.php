 ...
 *
 *      $Id: table_sanree_brand_record.php sanree checkedby.liuhuan.2014-05-02 $
 */
...
class table_sanree_brand_record  extends discuz_table {


	public function __construct() {

		$this->_table = 'sanree_brand_record';
		$this->_pk    = 'rid';
