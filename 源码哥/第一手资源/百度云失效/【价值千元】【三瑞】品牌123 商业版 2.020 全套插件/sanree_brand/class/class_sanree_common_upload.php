 ...
 *
 *      $Id: forum_upload.php 2014-07-29 10:20:00 sanree checkedby fx8.cc $
 */
...
class sanree_common_upload {
	...
	function uploadmsg($statusid) {
		...
		echo 'DISCUZUPLOAD|1|'.$statusid.'|'.$this->aid.'|'.$this->attach['isimage'].'|'.$this->attach['attachment'].'|'.$this->attach['name'].'|'.$this->error_sizelimit.'|'.$this->newbanner_flag;
		exit;
	}
}
//www-FX8-co
