...
function showpicedit(pre) {
	pre = pre ? pre : 'pic';
	if(document.getElementById(pre+'way_remote').checked) {
		document.getElementById(pre+'_remote').style.display = "block";
		document.getElementById(pre+'_upload').style.display = "none";
	} else {
		document.getElementById(pre+'_remote').style.display = "none";
		document.getElementById(pre+'_upload').style.display = "block";
	}
}
