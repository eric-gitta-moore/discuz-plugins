...
<!--{if in_array($_GET[action], array('delpost', 'banpost', 'warn'))}-->
	...
	<!--{elseif $_GET[action] == 'banpost'}-->
		...
		<dd class="tip_two"><input type="submit" name="modsubmit" id="modsubmit" value="{lang confirms}" class="apnc"><a href="javascript:;" onclick="popup.close();" class="apn">{lang cancel}</a></dd>
...
<!--{else}-->
		...
		<dd class="tip_one"><input type="button" onclick="popup.close();" value="{lang confirms}" class="apn" /></dd>
<!--{/if}-->
</div>
