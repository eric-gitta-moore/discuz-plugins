...
<div class="ainuo_fpostbottom cl">
	<ul>
    	<li><a href="javascript:;" class="ashare"><i class="iconfont icon-share"></i></a></li>
    	<li style="float:left;"><a href="#" class="back"><i class="iconfont icon-back"></i></a></li>
        <li><a href="javascript:;" class="favbtn">{if !$favid}<i class="iconfont icon-favor"></i>{else}<i class="iconfont icon-favorfill iconfontzanfill"></i>{/if}</a></li>
        <li class="haop"><a href="javascript:;" class="ainuozan">{if $zanfouzan}<i class="iconfont icon-appreciatefill iconfontzanfill"></i>{else}<i class="iconfont icon-appreciate"></i>{/if}<span id="ainuozannum">$_G[forum_thread][recommend_add]</span></a></li> 
        {if $_G[uid]}
		<li class="fastcon cl"><a href="javascript:;" class="fastcon_a"><em>$alang_xpinglun</em></a></li>
        {else}
        <li class="fastcon cl"><a href="javascript:;" class="ainuo_nologin"><em>$alang_xpinglun</em></a></li>
        {/if}
