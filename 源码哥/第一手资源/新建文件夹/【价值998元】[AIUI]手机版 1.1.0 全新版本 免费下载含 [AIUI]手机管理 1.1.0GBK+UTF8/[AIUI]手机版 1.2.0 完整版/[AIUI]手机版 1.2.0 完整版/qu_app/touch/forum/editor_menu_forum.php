...
<div class="p_pof" id="{$editorid}_image_menu" style="display: none" unselectable="on">
	<div class="fwin">
    	<div class="apost_img">
            <ul class="ainuo_imgpost cl" id="{$editorid}_image_ctrl">
                <span class="close" onclick="hideAttachMenu('image')">X</span>
                <!--{if $allowpostimg}-->
            ...
            <div unselectable="on" id="{$editorid}_www" {if $allowpostimg || helper_access::check_module('album')}style="display: none;"{/if}>
                ...
                <div class="o">
                    <button type="button" class="a_btn1" id="{$editorid}_image_submit"><strong>{lang submit}</strong></button>
                </div>
            </div>
	<!--{if $allowpostimg}-->
		...
		<div unselectable="on" id="{$editorid}_local" style="display: none;">
			<div class="p_opt">
				...
				<div class="upbk pbm bbda">
					...
					<p id="imguploadbtn">
						<button class="a_btn2" type="button" onclick="uploadAttach(0, 0, 'img')"><span>{lang upload}</span></button>
					</p>
		...
		<div unselectable="on" id="{$editorid}_imgattachlist">
			...
			<div class="notice upnf">
				Tip:{lang e_img_insertphoto}
			</div>
			</div>
			<div class="o">
				<button onclick="hideAttachMenu('image')" class="a_btn1">
					<strong>{lang confirms}</strong>
				</button>
			</div>
		</div>
	...
	<!--{if helper_access::check_module('album')}-->
		<div unselectable="on" id="{$editorid}_albumlist" {if $allowpostimg}style="display: none;"{/if}>
			...
			<div class="o">
				<button onclick="hideAttachMenu('image')" class="a_btn1">{lang confirms}</button>
			</div>
		</div>
	<!--{/if}-->
