...
class table_hjbox_buttons extends discuz_table{
    public function __construct() {
        $this->_table = 'hjbox_buttons';
        $this->_pk = 'id';
        parent::__construct();
    }
    ...
    public function fetch_zhu_all(){
         return DB::fetch_all('select * from %t where sid = 0 order by status asc,id desc',array($this->_table));
    }
