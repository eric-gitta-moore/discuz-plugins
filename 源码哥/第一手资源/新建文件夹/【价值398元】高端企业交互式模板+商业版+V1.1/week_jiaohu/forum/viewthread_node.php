			...
			<div class="pti">
				...
				<div class="authi">
                    <!--{if $close_leftinfo && !$post['anonymous'] && $postshowavatars && $showavatars}-->
                        <div class="z">
                            <a href="home.php?mod=space&uid=$post[authorid]" target="_blank" class="xi2 z wk_tzimg" style="padding-right:15px;">{echo avatar($post['authorid'], 'small')}</a>
                        </div>
                    <!--{/if}-->
                    <div class="wk_ckhf">
                    ...
                    <!--{if $close_leftinfo}-->
                        <!--{if !IS_ROBOT && !$_G['forum_thread']['archiveid'] && $post['first'] }-->
                        <div class="clear"></div>
                        <span class="xg1">{lang show} : </span> <span class="xi1">$_G[forum_thread][views]</span><span class="pipe"></span><span class="pipe">|</span><span class="pipe"></span><span class="xg1">{lang reply} : </span> <span class="xi1">$_G[forum_thread][allreplies]</span>
                        <!--{/if}-->
                    <!--{/if}-->
