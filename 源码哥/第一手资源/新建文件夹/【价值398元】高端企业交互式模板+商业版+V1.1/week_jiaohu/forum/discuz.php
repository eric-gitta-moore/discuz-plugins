...
<div id="ct" class="wp cl{if $_G['setting']['forumallowside']} ct2{/if} week_ct2">
<div class="mn wk_sq_mn">

	<div class="wk_f_mn padding15 backfff mb10">
    	<div class="wk_sqhdp"><!--[diy=wk_lthdp]--><div id="wk_lthdp" class="area"></div><!--[/diy]--></div>
	</div>

    <div class="wk_f_mn padding15 backfff">
    	<!--{if empty($gid)}-->
    ...
    <div id="sd" class="sd wk_f_sd">
        <!--{hook/index_side_top}-->
        <div class="drag">
            <!--[diy=diy2]--><div id="diy2" class="area"></div><!--[/diy]-->
        </div>
        <div class="wk_kd260 padding15 backfff">
            <a onclick="showWindow('nav', this.href, 'get', 0)" href="forum.php?mod=misc&amp;action=nav" title="$forum_lang[27]" class="wk_tzpost"><i class="icon wk_tzpost_icon1"></i><span>$forum_lang[27]</span></a>
            <a href="plugin.php?id=dsu_paulsign:sign" title="$forum_lang[29]" class="wk_tzpost"><i class="icon wk_tzpost_icon3"></i><span>$forum_lang[29]</span></a>
          <div class="clear"></div>
      </div>
        <div class="clear"></div>
        ...
        <div class="clear"></div>
      <div class="mb10"><!--[diy=wk_bkad_diy1]--><div id="wk_bkad_diy1" class="area"></div><!--[/diy]--></div>
        <div class="clear"></div>
        <div class="wk_kd260 padding15 backfff">
            <div class="wk_bktjtz">
...
<script type="text/javascript" src="$_G['style'][styleimgdir]/js/jquery-week.js"></script>
