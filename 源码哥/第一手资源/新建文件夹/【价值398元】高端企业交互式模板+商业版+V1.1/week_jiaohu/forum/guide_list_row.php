				...
				<!--{if $list['threadcount']}-->
						<!--{loop $list['threadlist'] $key $thread}-->
							<tbody id="$thread[id]">
								<tr>
                                	<td class="icon">
                                        <a href="home.php?mod=space&uid=$thread[authorid]" class="w_uid"><!--{avatar($thread[authorid],small)}--></a>
                                	</td>
									<td class="icn">
									...
									<th class="$thread[folder]">
                                    	<span class="w_bkmc">[<a href="forum.php?mod=forumdisplay&fid=$thread[fid]" target="_blank">$list['forumnames'][$thread[fid]]['name']</a>]</span>
									...
									<td class="by">
										<span class="ico_reply"><a href="forum.php?mod=viewthread&tid=$thread[tid]&extra=$extra"><!--{if $thread[replies]}-->$thread[replies]<!--{else}-->0<!--{/if}--></a></span>
									</td>
									<td class="by">
