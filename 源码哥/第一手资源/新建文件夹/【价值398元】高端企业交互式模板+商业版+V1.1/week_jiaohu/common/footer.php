    ...
    <div id="wk_ft">
    	<section class="section fp-auto-height">
            <div class="wk_footer_side">
                <div class="wk_footer">
                	Copyright &copy; 2016 <a href="http://www.ymg6.Com" target="_blank">FX8 Inc.</a>  All Rights Reserved. By <a href="http://www.ymg6.com/?RvMznky" title="FX8!" target="_blank">FX8!</a> <em>$_G['setting']['version']</em><!--{if !empty($_G['setting']['boardlicensed'])}--> <a href="http://www.ymg6.com/?R77BhwO" target="_blank">Licensed</a><!--{/if}--> <a title="FX8 Design By fx8.cc" target="_blank">$week_lang[5]</a> <!--$week_lang[6]--><br /><!--{if $_G['setting']['icp']}-->$week_lang[13]<a href="http://www.fx8.cc/?Jt2oC5" target="_blank" title="$_G['setting']['icp']">$_G['setting']['icp']</a><!--{/if}--><!--{hook/global_footerlink}--><!--{if $_G['setting']['statcode']}-->$_G['setting']['statcode']<!--{/if}-->
                </div>
            </div>
		</section> 
