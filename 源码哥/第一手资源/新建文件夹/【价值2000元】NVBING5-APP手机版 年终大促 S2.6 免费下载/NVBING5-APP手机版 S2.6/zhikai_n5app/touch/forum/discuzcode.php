...
<div class="box box_ex2 attach">
	<dd>
		...
		<p class="xg1">$attach[attachsize]<!--{if $attach['price']}-->&nbsp;<strong class="xi1">$attach[price] {$_G['setting']['extcredits'][$_G['setting']['creditstransextra'][1]][unit]}{$_G['setting']['extcredits'][$_G['setting']['creditstransextra'][1]][title]}</strong><!--{/if}--></p>
...
<!--{block return}-->
	...
	<!--{else}-->
		...
		<div id="attach_$attach[aid]" class="box attach mbn" >
			...
			<!--{/if}-->
			<em class="xg1">$attach[attachsize]<!--{if $attach['price']}-->&nbsp;<strong class="xi1">$attach[price] {$_G['setting']['extcredits'][$_G['setting']['creditstransextra'][1]][unit]}{$_G['setting']['extcredits'][$_G['setting']['creditstransextra'][1]][title]}</strong><!--{/if}--></em>
			<em class="xg1">{lang downloads}: $attach[downloads], $attach[dateline] {lang upload}</em>
