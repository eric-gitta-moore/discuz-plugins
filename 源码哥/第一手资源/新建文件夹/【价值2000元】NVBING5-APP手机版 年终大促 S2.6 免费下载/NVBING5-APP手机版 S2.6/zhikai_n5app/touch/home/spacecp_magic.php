...
<div class="n5gr_wewm cl">
    ...
    <div class="wewm_hyxx cl">
	    <div class="hyxx_hytx z cl"><!--{avatar($_G[uid])}--></div>
		<div class="hyxx_hymc z cl"><h2>$_G[username]</h2><p>{$n5app['lang']['kjssewmts']}</p></div>
	</div>
	<div class="wewm_ewmt cl"><div id="qrcode"></div></div>
</div>
<script type="text/javascript">
var qrcode = new QRCode(document.getElementById("qrcode"), {
    text: "$_G['setting'][siteurl]/home.php?mod=space&uid=$_G['uid']&do=profile&view=me",
    width: 400,
    height: 400,
    colorDark : "#000000",
    colorLight : "#ffffff",
