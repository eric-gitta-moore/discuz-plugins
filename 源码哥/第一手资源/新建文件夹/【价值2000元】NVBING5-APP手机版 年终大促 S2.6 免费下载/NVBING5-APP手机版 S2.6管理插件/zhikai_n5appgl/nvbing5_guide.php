<?php
function glr_fun1($thread){
	global $_G,$n5app;
	return  in_array($thread['fid'],$n5app['forums']);
}
function glr_fun2($thread){
	global $_G,$n5app;
...
function glr_fun5($thread,$xlmm_tp){
	global $_G,$n5app;
	if($xlmm_tp ==1){
		$length = 95;
