...
<div class="lewei_footer">
		<div class="lewei_footer_c">
				<p> 
						...
						<!--{if $_G['setting']['icp']}--><a href="http://www.miitbeian.gov.cn/" target="_blank"><span class="pipe">|</span> $_G['setting']['icp']</a><!--{/if}--> 
						<!--{hook/global_footerlink}--> 
						<!--{if $_G['setting']['statcode']}-->$_G['setting']['statcode']<!--{/if}--> 
				</p>
		</div>
		<div class="lewei_ft clearfix">
				<div class="weixin1"> <img src="$_G['style'][styleimgdir]/lewei_img/weixin.png" alt="官方微信"> <span>关注官方微信</span> </div>
				<div class="weixin3 weixin1"> <img src="$_G['style'][styleimgdir]/lewei_img/shouji.png" alt="手机访问"> <a target="_blank" href="#">手机扫描访问</a> </div>
				...
				<div class="lewei_ft_call">
						...
						<a href="http://wpa.qq.com/msgrd?v=3&amp;uin=$_G['setting']['site_qq']&amp;site=qq&amp;menu=yes" target="_blank" title="QQ" class="ntkf-chat"><img src="$_G['style'][styleimgdir]/lewei_img/lewei_call.png"></a> 
						<!--{/if}--> 
				</div>
		</div>
		<div id="ft" class="wp cl">
				<div id="flk">
						<p>Powered by <strong><a href="http://www.ymg6.net" target="_blank">Discuz!</a></strong> <em>$_G['setting']['version']</em><!--{if !empty($_G['setting']['boardlicensed'])}--> <a href="http://license.comsenz.com/?pid=1&host=$_SERVER[HTTP_HOST]" target="_blank">Licensed</a><!--{/if}-->&copy; 2001-2013 <a href="http://www.ymg6.com" target="_blank">源码哥</a> Inc.</p>
