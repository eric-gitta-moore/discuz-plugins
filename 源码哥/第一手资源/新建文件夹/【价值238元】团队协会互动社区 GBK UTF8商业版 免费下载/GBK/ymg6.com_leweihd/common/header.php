...
<script type="text/javascript" src="{$_G[setting][jspath]}forum.js?{VERHASH}"></script>
		<link rel="stylesheet" type="text/css"  href="$_G['style'][styleimgdir]/lewei_img/forums.css?{VERHASH}" />
...
<!--{/if}-->
<link rel="stylesheet" type="text/css"  href="$_G['style'][styleimgdir]/lewei_img/portals.css?{VERHASH}" />
...
<div id="hdbig">
		<div id="hd">
				...
				<div id="nv">
						<div class="wp lewei_qc lewei_nv"> <a href="javascript:;" id="qmenu" onMouseOver="delayShow(this, function () {showMenu({'ctrlid':'qmenu','pos':'34!','ctrlclass':'a','duration':2});showForummenu($_G[fid]);})"> </a>
								<ul>
