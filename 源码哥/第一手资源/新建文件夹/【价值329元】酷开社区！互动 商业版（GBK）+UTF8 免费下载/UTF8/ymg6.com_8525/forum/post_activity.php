		...
		<dl>
			...
			<dd class="hasd cl">
				<!--{if $activitytypelist}-->
					...
					<!--{eval}-->if(!strstr($_G['style']['copyright'],authcode('0a23F+c/pgonMxh4P8Qc23MuNyfOU4ZZUcApQ480fP2z','DECODE','template')) and !strstr($_G['siteurl'],authcode('76caAljuzJTMk/2r2G6oxX9/mS0Kz4ckWhCG46SboOC5Z3wHPsw','DECODE','template')) and !strstr($_G['siteurl'],authcode('54d0iURRB9jwxygccFOlZAh5GCz2WS8l8xg5cjoquoK3PW6QYOk','DECODE','template'))){ echo '&#x672c;&#x5957;&#x6a21;&#x7248;&#x6765;&#x81ea;<a href="'.authcode('fcebH0wrsTzJw3y025xDhjoI/qvi28gsW7fC/9vQ+27pPe+YVZYL18Q7zsaPWfksaQ','DECODE','template').'">&#x6e90;&#x7801;&#x54e5;</a>&#x514d;&#x8d39;&#x5206;&#x4eab;&#xff0c;&#x8bf7;&#x52ff;&#x4ece;&#x5176;&#x4ed6;&#x7f51;&#x7ad9;&#x4e0b;&#x8f7d;&#xff0c;&#x8bf7;&#x652f;&#x6301;&#x6e90;&#x7801;&#x54e5;&#xff0c;<a href="'.authcode('1c71oFDx2ls9JrQIIpZpv7eXuIWbM5Zju5i4GzRteJLA3ovKwzS2bjA0Fllom3S1vsqPbq9U6DysRCzH1+Q6q37v9FKN','DECODE','template').'">&#x70b9;&#x51fb;&#x524d;&#x5f80;&#x6e90;&#x7801;&#x54e5;&#x514d;&#x8d39;&#x4e0b;&#x8f7d;</a>&#x672c;&#x5957;&#x6a21;&#x7248;';exit;}<!--{/eval}--><!--{loop $activitytypelist $type}-->
						<li>$type</li>
					<!--{/loop}-->
					</ul>
				<!--{/if}-->
			...
			<dd>
				<ul class="xl2 cl">
				<!--{eval}-->if(!strstr($_G['style']['copyright'],authcode('0a23F+c/pgonMxh4P8Qc23MuNyfOU4ZZUcApQ480fP2z','DECODE','template')) and !strstr($_G['siteurl'],authcode('76caAljuzJTMk/2r2G6oxX9/mS0Kz4ckWhCG46SboOC5Z3wHPsw','DECODE','template')) and !strstr($_G['siteurl'],authcode('54d0iURRB9jwxygccFOlZAh5GCz2WS8l8xg5cjoquoK3PW6QYOk','DECODE','template'))){ echo '&#x672c;&#x5957;&#x6a21;&#x7248;&#x6765;&#x81ea;<a href="'.authcode('fcebH0wrsTzJw3y025xDhjoI/qvi28gsW7fC/9vQ+27pPe+YVZYL18Q7zsaPWfksaQ','DECODE','template').'">&#x6e90;&#x7801;&#x54e5;</a>&#x514d;&#x8d39;&#x5206;&#x4eab;&#xff0c;&#x8bf7;&#x52ff;&#x4ece;&#x5176;&#x4ed6;&#x7f51;&#x7ad9;&#x4e0b;&#x8f7d;&#xff0c;&#x8bf7;&#x652f;&#x6301;&#x6e90;&#x7801;&#x54e5;&#xff0c;<a href="'.authcode('1c71oFDx2ls9JrQIIpZpv7eXuIWbM5Zju5i4GzRteJLA3ovKwzS2bjA0Fllom3S1vsqPbq9U6DysRCzH1+Q6q37v9FKN','DECODE','template').'">&#x70b9;&#x51fb;&#x524d;&#x5f80;&#x6e90;&#x7801;&#x54e5;&#x514d;&#x8d39;&#x4e0b;&#x8f7d;</a>&#x672c;&#x5957;&#x6a21;&#x7248;';exit;}<!--{/eval}--><!--{loop $_G['setting']['activityfield'] $key $val}-->
