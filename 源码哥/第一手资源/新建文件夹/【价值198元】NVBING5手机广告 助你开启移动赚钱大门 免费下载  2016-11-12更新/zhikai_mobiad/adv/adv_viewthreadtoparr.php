...
class adv_viewthreadtoparr {

	var $version = '1.0';
	var $name = 'viewthreadtoparr_name';
	var $description = 'viewthreadtoparr_desc';
...
function getsetting() {
		...
		$settings = array(
			'fids' => array(
				'title' => 'viewthreadtoparr_fids',
				'type' => 'mselect',
				'value' => array(),
			),

			'pnumber' => array(
				'title' => 'viewthreadtoparr_pnumber',
				'type' => 'mselect',
				'value' => array(),
				'default' => array(0),
			),
