...
class adv_viewthreadbottomarr {

	var $version = '1.0';
	var $name = 'viewthreadbottomarr_name';
	var $description = 'viewthreadbottomarr_desc';
...
function getsetting() {
		...
		$settings = array(
			'fids' => array(
				'title' => 'viewthreadbottomarr_fids',
				'type' => 'mselect',
				'value' => array(),
			),

			'pnumber' => array(
				'title' => 'viewthreadbottomarr_pnumber',
				'type' => 'mselect',
				'value' => array(),
				'default' => array(0),
			),
		...
		for($i = 1;$i <= $_G['setting']['mobile']['mobilepostperpage'];$i++) {
