...
<title>远程上传</title>
<link href="source/plugin/baidu/api/default.css" rel="stylesheet" type="text/css" />
<link href="source/plugin/baidu/api/uploadify.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="source/plugin/baidu/api/jquery-1.3.2.min.js"></script>
<script type="text/javascript" src="source/plugin/baidu/api/swfobject.js"></script>
<script type="text/javascript" src="source/plugin/baidu/api/jquery.uploadify.v2.1.0.js"></script>
<script type="text/javascript">
$(document).ready(function() {
	$("#uploadify").uploadify({
		'uploader': 'source/plugin/baidu/api/uploadify.swf',
		'script': 'source/plugin/baidu/api/uploads.php',
		'cancelImg': 'source/plugin/baidu/api/cancel.png',
		'folder': 'upload',
		'method': 'GET',
		'queueID': 'fileQueue',
		'auto': true,
		...
		'buttonImg': 'source/plugin/baidu/api/up.png',
		'width': '75',
		'height': '28',
		'wmode': 'transparent',
...
<div class="uploadbox" style="width:595px; margin:20px auto;padding: 3px !important;border: 0px;!important;height:30px !important;position:relative;overflow:hide;background-image: url(source/plugin/baidu/api/bg.jpg);">
