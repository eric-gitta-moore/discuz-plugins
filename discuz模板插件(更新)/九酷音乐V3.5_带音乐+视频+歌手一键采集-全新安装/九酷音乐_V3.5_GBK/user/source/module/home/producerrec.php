...
<head>
	...
	<title>音乐认证推荐 - <?php echo cd_webname; ?></title>
...
<div class="people_content">
	<div class="title">
		...
		<ul class="right">
			...
			<li class="certification"><a class="indexList on" sid="list3" href="<?php echo cd_upath.rewrite_url('index.php?p=home&a=usersharerec'); ?>">音乐分享人推荐</a><b></b></li>
			<li class="certification on"><a class="indexList on" sid="list3" href="<?php echo cd_upath.rewrite_url('index.php?p=home&a=producerrec'); ?>">音乐认证推荐</a><b></b></li>
		</ul>
	</div>
	<div class="content">
		<ul class="people">
			<?php
				$a = 0;
				$sql = "select * from ".tname('user')." where cd_lock=0 and cd_checkmusic=1 and cd_isbest=1 order by cd_id desc";
				$Arr = getwebpage($sql,50,"index.php?p=home&a=producerrec");
				$result = $db->query($Arr[2]);
				$num = $db->num_rows($result);
				if($num==0){
					echo '<div class="nothing">暂时还没有音乐认证推荐啊！</div>';
				}else{
					if($result){
