...
<head>
	...
	<title>谁赞过我 - <?php echo cd_webname; ?></title>
			...
			<div class="uMain_content">
				<div class="main_nav">
					<ul>
						...
						<li class="praise">
							<a class="on" href="<?php echo cd_upath.rewrite_url('index.php?p=relation&a=userPraiseIn'); ?>">赞与被赞</a>
						</li>
						<li class="visitor">
				...
				<div class="main_nav2">
					<ul>
						<li class="current">
							<a href="<?php echo cd_upath.rewrite_url('index.php?p=relation&a=userPraiseIn'); ?>">谁赞过我</a>
						</li>
						<li>
							<a href="<?php echo cd_upath.rewrite_url('index.php?p=relation&a=userPraiseOut'); ?>">我赞过谁</a>
						</li>
					</ul>
				...
				<div class="minHeight500">
					<div class="relation_userlist">
						<?php
							global $db;
							$sql = "select * from ".tname('fans')." where cd_uids='$qianwei_in_userid' order by cd_addtime desc";
							...
							if($result){
								if($num>0){
									...
									echo '<div class="nothing">没有人赞过呢！</div>';
								}
							}
						?>
					</div>
