...
<head>
	...
	<title>已审歌手 - <?php echo cd_webname; ?></title>
		...
		<div class="user_main">
			<div class="uMain_content">
				<div class="main_nav">
					<ul>
						<li class="concert">
							<a class="on" href="<?php echo cd_upath.rewrite_url('index.php?p=singer&a=list'); ?>">已审歌手</a>
						</li>
						<li class="find">
				...
				<div class="main_nav2">
					<ul>
						<li<?php if($classId == ""){echo " class=\"current\"";} ?>><a href="<?php echo cd_upath.rewrite_url('index.php?p=singer&a=list'); ?>">全部类型</a></li>
						<?php
							echo "<li";
							if($classId == "华语歌手"){
								echo " class=\"current\"";
							}
							echo "><a href=\"".cd_upath."index.php?p=singer&a=list&classId=华语歌手\">华语歌手</a></li>";
							echo "<li";
							if($classId == "欧美歌手"){
								echo " class=\"current\"";
							}
							echo "><a href=\"".cd_upath."index.php?p=singer&a=list&classId=欧美歌手\">欧美歌手</a></li>";
							echo "<li";
							if($classId == "日韩歌手"){
								echo " class=\"current\"";
							}
							echo "><a href=\"".cd_upath."index.php?p=singer&a=list&classId=日韩歌手\">日韩歌手</a></li>";
						?>
					</ul>
				...
				<div id="imageList" class="minHeight500">
						...
						<?php
							...
							if($num==0){
								echo '<div class="nothing">暂无已审歌手。</div>';
							}else{
								if($result){
