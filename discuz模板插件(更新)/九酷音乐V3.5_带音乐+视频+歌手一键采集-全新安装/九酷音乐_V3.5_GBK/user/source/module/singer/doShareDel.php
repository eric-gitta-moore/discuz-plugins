<?php
	...
	if($qianwei_in_userid){
		...
		$db->query("delete from ".tname('feed')." where cd_icon='singer' and cd_dataid=".$cd_id);
		$db->query("delete from ".tname('singer')." where CD_User='".$qianwei_in_username."' and CD_ID = '$cd_id'");
