...
if($row=$db->getrow($sql)){
	...
	echo "<list><m type=\"".$type."\" src=\"".$player."\" label=\"".$row['CD_Name']." - ".GetSingerAlias("qianwei_singer","CD_Name","CD_ID",$row['CD_SingerID'])."\" lrc=\"".cd_upath."static/swf/lyrics.php?id=".$row['CD_ID']."\" _fav=\"".LinkFavUrl($row['CD_ID'])."\" _down=\"".LinkDownUrl($row['CD_ID'])."\" /></list>";
}
?>