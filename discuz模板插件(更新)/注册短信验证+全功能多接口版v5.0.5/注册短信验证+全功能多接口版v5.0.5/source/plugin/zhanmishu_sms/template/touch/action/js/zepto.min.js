var Zepto = function() {
	...
	function h(t) {
		var e, n;
		return D[t] || (e = k.createElement(t), k.body.appendChild(e), n = getComputedStyle(e, "").getPropertyValue("display"), e.parentNode.removeChild(e), "none" == n && (n = "block"), D[t] = n), D[t]
	}
	...
	return G.matches = function(t, e) {
		...
		var i, r, a;
		return F.test(t) && (i = S(k.createElement(RegExp.$1))), i || (t.replace && (t = t.replace(R, "<$1></$2>")), e === E && (e = $.test(t) && RegExp.$1), e in V || (e = "*"), a = V[e], a.innerHTML = "" + t, i = S.each(M.call(a.childNodes), function() {
			a.removeChild(this)
		...
		offset: function(t) {
			...
			if (!S.contains(k.documentElement, this[0])) return {
				top: 0,
				left: 0
			};
		...
		css: function(e, n) {
			...
			if ("string" == t(e)) n || 0 === n ? a = u(e) + ":" + f(e, n) : this.each(function() {
				...
				for (T in e) e[T] || 0 === e[T] ? a += u(T) + ":" + f(T, e[T]) + ";" : this.each(function() {
		...
		offsetParent: function() {
			return this.map(function() {
				for (var t = this.offsetParent || k.body; t && !_.test(t.nodeName) && "static" == S(t).css("position");) t = t.offsetParent;
				return t
			})
		}
...
window.Zepto = Zepto, void 0 === window.$ && (window.$ = Zepto),
	function(t) {
		...
		j.href = window.location.href, t.active = 0, t.ajaxJSONP = function(e, n) {
			...
			i(c), c.crossDomain || (n = y.createElement("a"), n.href = c.url, n.href = n.href, c.crossDomain = j.protocol + "//" + j.host != n.protocol + "//" + n.host), c.url || (c.url = window.location.toString()), (r = c.url.indexOf("#")) > -1 && (c.url = c.url.slice(0, r)), h(c);
			var d = c.dataType,
				g = /\?.+=\?/.test(c.url);
			...
			if (p && p.promise(C), c.crossDomain || E("X-Requested-With", "XMLHttpRequest"), E("Accept", w || "*/*"), (w = c.mimeType || w) && (w.indexOf(",") > -1 && (w = w.split(",", 2)[0]), C.overrideMimeType && C.overrideMimeType(w)), (c.contentType || c.contentType !== !1 && c.data && "GET" != c.type.toUpperCase()) && E("Content-Type", c.contentType || "application/x-www-form-urlencoded"), c.headers)
				for (v in c.headers) E(v, c.headers[v]);
			...
			if (c.xhrFields)
				for (v in c.xhrFields) C[v] = c.xhrFields[v];
			var P = "async" in c ? c.async : !0;
			C.open(c.type, c.url, P, c.username, c.password);
			for (v in x) O.apply(C, x[v]);
	...
	function(t) {
		t.Callbacks = function(e) {
			...
			var n, i, r, o, a, s, c = [],
				u = !e.once && [],
				l = function(t) {
					for (n = e.memory && t, i = !0, s = o || 0, o = 0, a = c.length, r = !0; c && a > s; ++s)
				...
				f = {
					...
					remove: function() {
						return c && t.each(arguments, function(e, n) {
							for (var i;
								(i = t.inArray(n, c, i)) > -1;) c.splice(i, 1), r && (a >= i && --a, s >= i && --s)
						}), this
					},
					has: function(e) {
	...
	function(t) {
		...
		t.when = function(i) {
			...
			if (c > 1)
				for (r = new Array(c), o = new Array(c), a = new Array(c); c > u; ++u) s[u] && t.isFunction(s[u].promise) ? s[u].promise().done(h(u, a, s)).fail(f.reject).progress(h(u, o, r)) : --l;
	...
	function(t, e) {
		...
		t.each(m, function(t, n) {
			...
			var b, w, x, E = {},
				...
				C = !1;
			if (r === e && (r = t.fx.speeds._default / 1e3), v === e && (v = 0), t.fx.off && (r = 0), "string" == typeof i) E[l] = i, E[f] = r + "s", E[p] = v + "s", E[h] = d || "linear", j = t.fx.animationEnd;
			else {
				w = [];
			...
			return x = function(e) {
				...
				} else t(this).unbind(j, x);
				C = !0, t(this).css(y), m && m.call(this)
			}, r > 0 && (this.bind(j, x), setTimeout(function() {
				C || x.call(S)
	...
	function(t) {
		...
		t(document).ready(function() {
			...
			"MSGesture" in window && (f = new MSGesture, f.target = document.body), t(document).bind("MSGestureEnd", function(t) {
				...
				(!(g = a(n, "up")) || o(n)) && (i(), h.x2 && Math.abs(h.x1 - h.x2) > 30 || h.y2 && Math.abs(h.y1 - h.y2) > 30 ? u = setTimeout(function() {
					h.el.trigger("swipe"), h.el.trigger("swipe" + e(h.x1, h.x2, h.y1, h.y2)), h = {}
				}, 0) : "last" in h && (30 > y && 30 > b ? c = setTimeout(function() {
					var e = t.Event("tap");
	...
	}(Zepto), "function" == typeof define && define.amd && define("zepto", [], function() {
		return Zepto
	}), jQuery = Zepto;